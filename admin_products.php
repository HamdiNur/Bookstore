...
// Check if id is set in the session (matching login.php)
...
$user_id = $_SESSION['id'];
$select_user = mysqli_query($conn, "SELECT * FROM `userss` WHERE id = '$user_id'") or die('Query failed: ' . mysqli_error($conn));
